...
function NavBarLogged() {
    ...
    const handleSidebarOpen = () => {
        toast.info('Sidebar is not implemented yet.', {
            ...
            toastId: 'sidebar-not-implemented',
        });
    };

    const handleEmailClick = () => {
        toast.info('Email is not implemented yet.', {
            // Make it dissapear faster
            autoClose: 1000,
            // Prevent duplicate toasts
            toastId: 'email-not-implemented',
        });
    };

    const handleNotificationClick = () => {
        toast.info('Notifications is not implemented yet.', {
            // Make it dissapear faster
            autoClose: 1000,
            // Prevent duplicate toasts
            toastId: 'notifications-not-implemented',
        });
    };
